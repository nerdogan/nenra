...
class Ui_Dialog4(object):
    def setupUi(self, Dialog4):
        ...
        self.dateEdit_2 = QtWidgets.QDateEdit(Dialog4)
        ...
        self.dateEdit.dateChanged['QDate'].connect(self.dateEdit_2.setDate)
        QtCore.QMetaObject.connectSlotsByName(Dialog4)

    def retranslateUi(self, Dialog4):
        _translate = QtCore.QCoreApplication.translate
        Dialog4.setWindowTitle(_translate("Dialog4", "Maliyet"))
        self.label.setText(_translate("Dialog4", "Başlama Tarihi"))
        self.label_2.setText(_translate("Dialog4", "Bitiş Tarihi"))
        self.pushButton.setText(_translate("Dialog4", "Ürün Maliyet Raporu"))
        self.pushButton_2.setText(_translate("Dialog4", "PDF Rapor "))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Dialog4", "Ürün Kodu"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog4", "Ürün Adı"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog4", "Satış Adedi"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Dialog4", "Tutar"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Dialog4", "Maliyet"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Dialog4", "Kar Oranı"))
        self.pushButton_3.setText(_translate("Dialog4", "Ürün Satış Raporu"))
