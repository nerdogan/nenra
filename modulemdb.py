...
class Myddb():
    def __init__(self):
        ...
        self.conn = MySQLdb.connect(tgtIP, nenraconfig._GetOption('user'), nenraconfig._GetOption('password'), 'sugarandsalt', charset='utf8',port=int(nenraconfig._GetOption('port')));
