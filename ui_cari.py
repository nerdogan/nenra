...
class Ui_Dialog5(object):
    def setupUi(self, Dialog5):
        ...
        self.dateEdit.setGeometry(QtCore.QRect(20, 130, 151, 41))
        font = QtGui.QFont()
        ...
        self.dateEdit_2.setGeometry(QtCore.QRect(20, 220, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 200, 141, 16))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton.setGeometry(QtCore.QRect(10, 290, 161, 51))
        font = QtGui.QFont()
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(10, 20, 161, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, Dialog5):
        Dialog5.setWindowTitle(_translate("Dialog5", "Maliyet", None))
        ...
        self.pushButton_2.setText(_translate("Dialog5", "PDF Rapor ", None))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Dialog5", "Tarih", None))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog5", "Kod", None))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog5", "Belge No", None))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Dialog5", "Açıklama", None))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Dialog5", "Borç", None))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Dialog5", "Alacak", None))
        self.pushButton_3.setText(_translate("Dialog5", "Firma Seç", None))
